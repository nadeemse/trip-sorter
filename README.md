...
## Run the application
Note that the source file used for this application is located in "src/Cards.php" path.
...
Also you can access index.php in browser by typing localhost/index.php
